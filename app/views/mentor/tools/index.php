                  ...
                  <div class="row align-items-end mt-4">
                    <form action="<?= BASEURL;?>/mentor/tools" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari Tools" name="keyword" id="keyword">
                            <button class="btn btn-primary" type="submit" id="tombolCari" autocomplete="off">Cari Tools</button>
                    </form>
                            <button type="button" class="btn btn-primary ModalTambahTools" data-bs-toggle="modal" data-bs-target="#formModalTools">
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <div class="d-grid gap-2 d-md-flex d-flex justify-content-md-center">
                                    ...
                                    class="btn btn-primary me-md-2 btn-sm ModalUbahTools" 
                                    data-bs-toggle="modal" data-bs-target="#formModalTools" 
                                    data-id="<?= $tools['id_tools']?>">Edit</a>
                                    <a href="<?= BASEURL;?>/tools/hapus/<?= $tools['id_tools']?>" 
                            ...
                            <td class="align-content-center align-self-center ">
                                ...
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    ...
                                    <img src="<?= BASEURL?>/public/img/assets/tools/<?= $tools['gambar']?>" alt="Avatar" class="rounded-circle  align-items-center" />
                                </ul>
                            </td>
                            <!-- Nama Tools -->
                            <td><?= $tools['nama_tools']?><br></td>
                            <!-- Preview -->
                            <td><a href="<?= $tools['link_download']?>" target="_blank" class="btn btn-info btn-sm">Link Materi</a></td>
                        </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>

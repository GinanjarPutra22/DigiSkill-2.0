<footer class="card">
            ...
            <div class="row row-content justify-content-between  justify-content-md-start">
                <div class="col-lg-4 col-md-6 mb-sm-4">
                    <a href="#" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-capitalize">DigiSkill</span>
                    </a>
                    <p class="fs-6 mt-2">DigiSKill merupakan platform media pembelajaran untuk menunjang skill digital
                        dimasa kini.</p>

                    <div class="d-flex gap-3">

                        <a href="https://www.instagram.com/ginanjar_putra22/" target="_blank">
                            <i class='tf-icons bx bxl-instagram-alt bx-sm btn btn-icon bx-md nav-link'></i>
                        </a>
                        <a href="https://www.instagram.com/ginanjar_putra22/" target="_blank">
                            <i class='tf-icons bx bxl-facebook-square bx-sm btn btn-icon bx-md nav-link'></i>
                        </a>
                        <a href="https://www.instagram.com/ginanjar_putra22/" target="_blank">
                            <i class='tf-icons bx bxl-youtube bx-sm btn btn-icon bx-md nav-link'></i>
                        </a>
                        <a href="https://www.instagram.com/ginanjar_putra22/" target="_blank">
                            <i class='tf-icons bx bxl-linkedin-square bx-sm btn btn-icon bx-md nav-link'></i>
                        </a>
                ...
                <div class="col-lg-3 offset-lg-1 col-md-6 mt-4 mt-sm-0 mb-sm-4">
                    ...
                    <div class="row d-flex mt-3">
                        <a class="nav-link fs-6" href="<?= BASEURL;?>/">Branda</a>
                        <a class="nav-link fs-6" href="<?= BASEURL;?>/about/">Tentang Kami</a>
                    </div>
                </div>
                <div class="col-lg-3 offset-lg-1 col-md-6 mt-4 mt-sm-0 mb-sm-4">
                    ...
                    <div class="row d-flex mt-3">
                        <?php foreach ($data['kategori'] as $kategori) :?>
                            <a class="nav-link fs-6" href="<?= BASEURL;?>/kategori/detail/<?= $kategori['id_kategori']?>"><?= $kategori['nama_kategori']?></a>
                        <?php endforeach;?>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between text-secondary">
                    <p class="fs-6">©Copyright 2023 all right reserved | Kelompok 5 Pemerogaman Web - PTI-B 2021 UNESA
                    </p>
                    <p class="fs-6"> Created by: <a href="#" class="fw-semibold text-secondary">Five Project Team's</a></p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <!-- Vendors JS -->
    <script src="<?= BASEURL;?>/public/js/swiper.js"></script>

...
<div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <?php foreach ($data['mentor'] as $usr) :?>
                        ...
                        <td>
                            <div class="d-grid gap-2 d-md-flex d-flex justify-content-md">
                                ...
                                class="btn btn-primary me-md-2 btn-sm ModalUbahMentor" 
                                data-bs-toggle="modal" data-bs-target="#formModalMentor" 
                        ...
                        <td class="align-content-center align-self-center ">
                            ...
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                ...
                                <img src="<?= BASEURL;?>/public/img/profile/<?= $usr['foto_mentor']?>" alt="Avatar" class="rounded-circle" />
                            </ul>
                        </td>
                        <!-- Nama -->
                        <td><?= $usr['nama_mentor']?></td>
                        <!-- Kelas -->
                        ...
                        <td><?= $usr['email']?></td>
                        <!-- Waktu Bergabung -->
                        <td class="text-center"><?= $usr['pekerjaan']?></td>
                        </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
            ...
            <h4 class="fw-bold  py-2 mt-3"><span class="text-muted fw-light"></span> Data Mentor Belum Memilih Kelas</h4>
            <div class="card">
              <!-- <h5 class="card-header">Hoverable rows</h5> -->
              <div class="table-responsive text-nowrap">
                <table class="table table-hover">

          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-5">
              <div class="d-flex justify-content-between m-4 align-items-center">
                ...
                <button type="button" class="btn btn-primary ModalTambahKategori" data-bs-toggle="modal" data-bs-target="#formModalKategori">
                    ...
                    <?php foreach ($data['kategori'] as $kls) :?>
                        <tr class="text-center">
                            ...
                            <td class="text-center  w-25 ">
                                ...
                                class="btn btn-primary me-md-2 btn-sm ModalUbahKategori" 
                                data-bs-toggle="modal" data-bs-target="#formModalKategori" 
                                data-id="<?= $kls['id_kategori']?>">Edit</a>

                                <a href="<?= BASEURL;?>/kategori/hapus/<?= $kls['id_kategori']?>" 
                                class="btn btn-danger btn-sm" onclick="return confirm('Yakin?')">Hapus</a>
                            </td>
                            <td class="text-center  w-25 "><?= $kls['nama_kategori']?></td>
                            <!-- Profil -->
                            <td class="text-center   ">
                                <img src="<?= BASEURL?>/public/img/assets/kategori/<?= $kls['hero_gambar']?>" alt="Avatar" class="avatar  h-25 "
                                data-popup="tooltip-custom" data-bs-placement="top">
                            </td>
                            <!-- Nama -->
                            <td class="text-start"><?= $kls['hero_deskripsi']?></td>
                        </tr>
                    <?php endforeach;?>
            ...
            <div class="card mb-5">
              <div class="d-flex justify-content-between m-4 align-items-center">
                ...
                <button type="button" class="btn btn-primary ModalTambahKelas" data-bs-toggle="modal" data-bs-target="#formModal">
                    Tambah Data Kelas
                </button>
              </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td class="">
                                <div class="d-grid gap-2 d-md-flex d-flex justify-content-md-center ">
                                    ...
                                    class="btn btn-primary me-md-2 btn-sm ModalUbahKelas" 
                                    data-bs-toggle="modal" data-bs-target="#formModal" 
                                    data-id="<?= $kls['id_kelas']?>">Ubah</a>

...
<div class="container my-lg-5 ">
        <div class="HERO row my-5">
            ...
            <div class="col-md-6 d-flex justify-content-center  order-md-2 order-lg-last">
                <img class="img w-75" src="<?= BASEURL;?>/public/img/assets/kategori/<?= $data['detail_kategori']['hero_gambar']?>" alt=""
            ...
            <div class="col-md-6 d-flex align-items-center authentication-inner">
                <div>
                    <p class="fs-5 fw-bold badge bg-label-primary"><?= $data['detail_kategori']['nama_kategori']?></p>
                    <p class=" fs-1 fw-bold">
                        <span class=" text-black">Belajar Materi</span> <span class="text-primary"><?= $data['detail_kategori']['nama_kategori']?></span>
                    ...
                    <div class="d-flex gap-2 align-content-center ">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="search" id="form1" class="form-control"
                                placeholder="Cari kelas UI/UX Design..." aria-label="Search" />
                        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 rounded ">
                <div class="card p-3 ">
                    <?php if(empty($data['kelas'])) {?>
                        <h1>Data Kosong</h1>
                    <?php }else{ foreach ($data['kelas'] as $kategori) :?>
                        <?php
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <p class="badge bg-label-primary fw-semibold"><?= $kategori['nama_kategori']?></p>
                        </div>
                        <div class="product-caption ">
                            ...
                            <div class="pt-2">
                                <ul class="bx-ul d-flex justify-content-between">
                                    <li><i class='bx bx-video'></i> <?= $kategori['total_materi']?> Video</li>
                                    <li><i class='bx bx-book'></i> <?= $kategori['total_materi']?> Materi</li>
                                    <li><i class='bx bx-user'></i> <?= $kategori['total_data_user']?> User</li>
                                </ul>
                            </div>
                            <div class="d-grid ">
                                ...
                                <?php } elseif (isset($_SESSION['id_profile'])) { ?>
                                    <a href="<?= BASEURL?>/materi/<?= $kategori['id_kelas']?>" class="btn btn-primary btn-sm mt-1 btn-lg px-3 py-2">Lihat Kelas</a>
                                <?php } else { ?>
                                    <a href="<?= BASEURL;?>/auth/" class="btn btn-primary btn-sm mt-1 btn-lg mb-2 px-3 py-2">Masuk Kelas</a>
                                <?php } ?>
                                <a href="<?= BASEURL;?>/kelas/detail/<?=$kategori['id_kelas']?>" class="btn  btn-outline-primary btn-sm mt-1 btn-lg px-3 py-2">Detail Kelas</a>    
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= BASEURL; ?>/pendaftaran/tambah" method="post">
                                            ...
                                            <input type="hidden" class="form-control" id="id_profile" name="id_profile" value="<?=$data['data_user']['id_profile']?>">
                                                <div class="mb-3">
                                                    <label for="nama_user" class="form-label">Nama</label>
                                                    <input type="text" class="form-control" id="nama_user" name= "nama_user" value="<?=$data['data_user']['nama_user']?>" readonly>
                                                </div>
                                                <div class="mb-3">

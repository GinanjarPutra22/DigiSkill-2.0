...
<div class="container my-lg-5">
    <div class="HERO row my-5">
        ...
        <div class="col-md-6 d-flex justify-content-center  order-md-2 order-lg-last">
            <img class="img w-100" src="<?= BASEURL;?>/public/img/illustrations/Hero 1.svg" alt="" class="justify-content-center" />
        </div>
        <!-- ENd img -->
        <!-- text section -->
        <div class="col-md-6 d-flex align-items-center authentication-inner">
            <div>
                ...
                <?php if(isset($_SESSION['id_profile'])){?>
                    <a href="#kelas" 
                        class="btn btn-primary">Belajar Sekarang
                    </a>
                <?php }else{?>
...
<div class="container rounded-2 mb-5  py-5"">  
    ...
    <div class="row content-value   mt-3 rounded">
        ...
        <div class="col-md-4 ">
            <div class="d-flex gap-3">
                <img src="<?= BASEURL;?>/public/img/icons/unicons/online-test 1.svg" class="img mb-4 p-3 bg-primary rounded"
                        alt="" />
                <div class="d-flex flex-column g-0 justify-content-start ">
        ...
        <div class="col-md-4 ">
            <div class="d-flex gap-3">
                <img src="<?= BASEURL;?>/public/img/icons/unicons/paypal.png" class="img mb-4 p-3 bg-primary rounded" alt="" />
                <div class="d-flex flex-column g-0 justify-content-start ">
...
<!-- Start Card Produk -->
<div class="container mt-5" id="kelas">
            ...
            <div class="col-lg-4 col-md-6 mb-4 rounded ">
                <div class="card p-3 ">
                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <p class="badge bg-label-primary fw-semibold"><?= $jml['nama_kategori']; ?></p>
                    </div>
                    <div class="product-caption ">
                        ...
                        <div class="pt-2">
                            <ul class="bx-ul d-flex justify-content-between">
                                <li><i class='bx bx-video'></i> <?= $jml['total_materi']; ?> Video</li>
                                <li><i class='bx bx-book'></i> <?= $jml['total_materi']; ?> Materi</li>
                                <li><i class='bx bx-user'></i> <?= $jml['total_data_user']; ?> User</li>
                            </ul>
                        </div>
                        <div class="d-grid ">
                            ...
                            if (isset($_SESSION['id_profile']) && !$telahDaftar) {?>
                                <a href="<?= BASEURL;?>/pendaftaran/tambah/<?= $jml['id_kelas']?>" 
                                    ...
                                    data-id="<?= $jml['id_kelas']?>">Masuk Kelas
                                </a>
                            <?php } elseif (isset($_SESSION['id_profile'])) { ?>
                                <a href="<?= BASEURL?>/materi/<?= $jml['id_kelas']?>" class="btn btn-primary btn-sm mt-1 btn-lg px-3 py-2">Lihat Kelas</a>
                            <?php } else { ?>
                                <a href="<?= BASEURL;?>/auth/" class="btn btn-primary btn-sm mt-1 btn-lg mb-2 px-3 py-2">Masuk Kelas</a>
                            <?php } ?>
                            <a href="<?= BASEURL;?>/kelas/detail/<?=$jml['id_kelas']?>" class="btn  btn-outline-primary btn-sm mt-1 btn-lg px-3 py-2">Detail Kelas</a>
                        </div>
                    </div>
                </div>
            </div>
